/**
 * CombatPilot - Pilot class for Combat mode
 * Adapted from maverick Pilot class
 */
class CombatPilot {
  constructor() {
    ...
    // Top hairs (12 total in 3x4 grid)
    for (let i = 0; i < 12; i++) {
      const h = hair.clone();
      const col = i % 3;
    ...
    console.log('[CombatPilot] Created');
  }

  /**
   * Update hair animation
   */
  updateHairs(deltaTime = 0.016) {
    ...
    this.angleHairs += (window.game?.speed || 0.001) * deltaTime * 40;
  }
}

// Export for use in other modules
if (typeof module !== 'undefined' && module.exports) {
  module.exports = CombatPilot;
} else if (typeof window !== 'undefined') {
  window.CombatPilot = CombatPilot;
}
